...
<head>
    ...
    <title>Dashboard - Meeting Management System</title>
    ...
    <style>
        ...
        .modal-header h2 { font-size: var(--font-size-xl); color: var(--primary-blue); }
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="left-panel">
            <header style="padding-bottom: 5px;">
                <div class="welcome-area">
                    <h1 style="font-size: 32px; color: var(--primary-blue); font-weight: 700; margin-bottom: 5px;">Welcome back, <?= htmlspecialchars($username) ?></h1>
                    <p style="color: var(--text-muted); font-size: 18px; font-weight: 500;"><?= $currentDate ?></p>
                </div>
            </header>

            <section class="stats-bento">
                <div class="bento-card glass">
                    <h3 style="font-size: 18px; color: var(--text-main); margin-bottom: 10px; font-weight: 600;">Total Meetings This Month</h3>
                    <div class="bento-number" id="stats-month">0</div>
                </div>
                <div class="bento-card glass" id="next-meeting-bento" style="display: flex; flex-direction: column; justify-content: center; align-items: center; border: 2px solid rgba(59, 130, 246, 0.3);">
                    ...
                    <div style="color: var(--accent); font-weight: 600; font-size: 16px; margin-bottom: 5px;">Starts in -- mins</div>
                    <div style="font-size: 24px; font-weight: 700; color: var(--text-main); line-height: 1.2;">No upcoming meetings</div>
                </div>
            </section>
            ...
            <div class="control-center glass" style="flex-direction: column; align-items: stretch; gap: 20px;">
                <div class="filter-chips" id="status-filters">
                    <div class="chip active" data-status="all">Show All</div>
                ...
                <div style="display: flex; gap: 20px;">
                    <div style="flex: 1;">
                        <input type="text" id="search-input" placeholder="Search for a meeting or student..." style="width: 100%; padding: 18px 24px; border-radius: var(--border-radius-md); border: 2px solid #e2e8f0; font-size: var(--font-size-lg); background: #f8fafc;">
                    </div>
                    <div>
                        <select id="filter-time-dropdown" style="padding: 18px 24px; border-radius: var(--border-radius-md); border: 2px solid #e2e8f0; font-size: var(--font-size-lg); font-weight: 600; background: #f8fafc; color: var(--primary-blue); cursor: pointer; min-width: 160px; height: 100%;">
        ...
        <div class="right-panel">
            <div class="top-actions">
                <button class="btn btn-accent" id="btn-add-event" onclick="openModal('add')" style="padding: 20px 40px; font-size: var(--font-size-lg); border-radius: 100px;">
    ...
    <div class="modal-overlay" id="view-modal">
        <div class="modal-content" style="max-width: 600px; padding: 40px;">
            <div style="margin-bottom: 25px;">
                <h2 id="view-title" style="word-break: break-word; font-size: 32px; color: var(--text-main); font-weight: 700; margin-bottom: 15px;">Meeting Title</h2>
                <div id="view-status-badge" class="status-badge badge-upcoming">🟡 Upcoming</div>
            </div>
            
            <div style="margin-bottom: 25px; display: flex; gap: 20px; flex-direction: column;">
                <div style="display: flex; align-items: center; gap: 15px; font-size: var(--font-size-xl); color: var(--text-main);">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--primary-blue)" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                    <span id="view-date" style="font-weight: 600;">Date</span>
                </div>
                <div style="display: flex; align-items: center; gap: 15px; font-size: var(--font-size-xl); color: var(--text-main);">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--primary-blue)" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                    <span id="view-time" style="font-weight: 600;">Time</span>
                </div>
            </div>
            
            <div style="margin-bottom: 30px; background: #f8fafc; padding: 25px; border-radius: var(--border-radius-md); border: 1px solid #e2e8f0; display: none;" id="view-desc-container">
                <div style="font-size: var(--font-size-base); color: var(--text-muted); text-transform: uppercase; font-weight: 700; margin-bottom: 10px;">Details</div>
                <p id="view-desc" style="color: var(--text-main); font-size: var(--font-size-lg); white-space: pre-wrap; line-height: 1.6;"></p>
            </div>
